...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  /** ver mirror */
  private JMenuItem verFlip;
  /** no red */
  private JMenuItem noRed;
  /** no blue */
  private JMenuItem noBlue;
  /** no green */
  private JMenuItem noGreen;
  /** flip horizontal */
  private JMenuItem flipHor;
  /** flip vertical */
  private JMenuItem flipVer;
  /** grayscale */
  private JMenuItem grayscale;
  /** brighten 50% */
  private JMenuItem bright50;
  /** brighten 200% */
  private JMenuItem bright200;
  /** brighten 10% */
  private JMenuItem bright10;
  /** brighten 110% */
  private JMenuItem bright110;
  /** black and white */
  ...
  private void setUpMenuBar()
  {
    ...
    horFlip = new JMenuItem("Mirror Horizontal");
    verFlip = new JMenuItem("Mirror Vertical");
    flipHor = new JMenuItem("Flip Horizontal");
    flipVer = new JMenuItem("Flip Vertical");
    noRed = new JMenuItem("Zero Red");
    noBlue = new JMenuItem("Zero Blue");
    noGreen = new JMenuItem("Zero Green");
    grayscale = new JMenuItem("Grayscale");
    bright50 = new JMenuItem("50% Brightness");
    bright10 = new JMenuItem("90% Brightness");
    bright200 = new JMenuItem("200% Brightness");
    bright110 = new JMenuItem("110% Brightness");
    ...
    horFlip.addActionListener(this);
    verFlip.addActionListener(this);
    ...
    bright50.addActionListener(this);
    bright10.addActionListener(this);
    bright200.addActionListener(this);
    bright110.addActionListener(this);
    ...
    flipMenu.add(flipHor);
    flipMenu.add(flipVer);
    colorMenu.add(noRed);
    colorMenu.add(noBlue);
    colorMenu.add(noGreen);
    colorMenu.add(grayscale);
    colorMenu.add(bright50);
    colorMenu.add(bright10);
    colorMenu.add(bright200);
    colorMenu.add(bright110);
    colorMenu.add(bw);
  ...
  private void enableZoomItems()
  {
    ...
    noRed.setEnabled(true);
    noGreen.setEnabled(true);
    noBlue.setEnabled(true);
    flipHor.setEnabled(true);
    flipVer.setEnabled(true);
    grayscale.setEnabled(true);
    bright50.setEnabled(true);
    bright10.setEnabled(true);
    bright200.setEnabled(true);
    bright110.setEnabled(true);
    bw.setEnabled(true);
  }
  ...
  public void actionPerformed(ActionEvent a)
  {
    ...
    if(a.getActionCommand().equals("Mirror Horizontal"))
    {
      PictureTester.mirrorHorizontal(picture);
      repaint();
      enableZoomItems();
      horFlip.setEnabled(false);
    }
    
    if(a.getActionCommand().equals("Mirror Vertical"))
    {
      PictureTester.mirrorVertical(picture);
      repaint();
      enableZoomItems();
    ...
    {
      PictureTester.zeroRed(picture);
      repaint();
      enableZoomItems();
      noRed.setEnabled(false);
    }
    
    if(a.getActionCommand().equals("Zero Blue"))
    {
      PictureTester.zeroBlue(picture);
      repaint();
      enableZoomItems();
      noBlue.setEnabled(false);
    }
    
    if(a.getActionCommand().equals("Zero Green"))
    {
      PictureTester.zeroGreen(picture);
      repaint();
      enableZoomItems();
      noGreen.setEnabled(false);
    }
    
    if(a.getActionCommand().equals("Flip Vertical"))
    {
      PictureTester.flipHorizontal(picture);
      repaint();
      enableZoomItems();
    }
    
    if(a.getActionCommand().equals("Flip Horizontal"))
    {
      PictureTester.flipVertical(picture);
      repaint();
      enableZoomItems();
    }
    ...
    {
      PictureTester.convertToBlackAndWhite(picture);
      repaint();
      enableZoomItems();
      grayscale.setEnabled(false);
    }
    
    if(a.getActionCommand().equals("50% Brightness"))
    {
      PictureTester.brighten(picture, 0.5);
      repaint();
      enableZoomItems();
    }
    
    if(a.getActionCommand().equals("90% Brightness"))
    {
      PictureTester.brighten(picture, 0.9);
      repaint();
      enableZoomItems();
    }
    
    if(a.getActionCommand().equals("200% Brightness"))
    {
      PictureTester.brighten(picture, 2.0);
      repaint();
      enableZoomItems();
    }
    
    if(a.getActionCommand().equals("110% Brightness"))
    {
      PictureTester.brighten(picture, 1.1);
      repaint();
      enableZoomItems();
    }
    
    if(a.getActionCommand().equals("Black and White"))
    {
      PictureTester.bw(picture);
      repaint();
      enableZoomItems();
      bw.setEnabled(false);
    }
